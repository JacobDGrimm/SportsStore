...
namespace SportsStore.UnitTests
{
    ...
    public class UnitTest1
    {
        ...
        public void Generate_Category_Specific_Product_Count()
        {
            ...
            int res1 = ((ProductsListViewModels)target
                .List("Cat1").Model).PagingInfo.TotalItems;
            int res2 = ((ProductsListViewModels)target
                .List("Cat2").Model).PagingInfo.TotalItems;
            int res3 = ((ProductsListViewModels)target
                .List("Cat3").Model).PagingInfo.TotalItems;
            int resAll = ((ProductsListViewModels)target
        ...
        public void Cannot_Checkout_Empty_Cart()
        {
            ...
            // Assert - check that I am passong an invalid model to the view
